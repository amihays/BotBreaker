(function () {
  ...
  Game.buildBodies = function () {
    ...
    var vertex2 = new BB.Vertex(new BB.Vector(300, 200), new BB.Vector(0, 0), new BB.Vector(0, 0), .1)
    var vertex3 = new BB.Vertex(new BB.Vector(250, 200), new BB.Vector(0, 0), new BB.Vector(0, 0), .1)

    var linSpring1_2 = new BB.LinearSpring(vertex1, vertex2, 0.1, 0.05, 50)
    var linSpring1_3 = new BB.LinearSpring(vertex1, vertex3, 0.1, 0.05, 50)
    var linSpring2_3 = new BB.LinearSpring(vertex2, vertex3, 0.1, 0.05, 50)
