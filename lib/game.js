(function () {
  ...
  var Game = BB.Game = function () {
    ...
    this.dt = .2;
    this.gravity = new BB.Vector(0, 0.5);
    this.logStuff();
  ...
  Game.buildBoundaries = function () {
    var ground = new BB.Ground(Game.DIM_Y, 0.5, 0.5);
    return [ground];
  }

  Game.buildBodies = function () {
    var vertex1 = new BB.Vertex(new BB.Vector(230, 200), new BB.Vector(0, 0), new BB.Vector(0, 0), 1)
    var vertex2 = new BB.Vertex(new BB.Vector(230.1, 400), new BB.Vector(0, 0), new BB.Vector(0, 0), 1)
    var vertex3 = new BB.Vertex(new BB.Vector(350, 400), new BB.Vector(0, 0), new BB.Vector(0, 0), 1)

    var linSpring1_2 = new BB.LinearSpring(vertex1, vertex2, 0.04, 0, 200)
    var linSpring1_3 = new BB.LinearSpring(vertex1, vertex3, 0.2, 0, 100)
    var linSpring2_3 = new BB.LinearSpring(vertex2, vertex3, .3, 0, 150)
