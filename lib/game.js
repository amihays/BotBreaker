(function () {
  ...
  Game.buildBoundaries = function () {
    var ground = new BB.Ground(Game.DIM_Y, 1, 0.5);
    return [ground];
  }

  Game.buildBodies = function () {
    var vertex1 = new BB.Vertex(new BB.Vector(230, 200), new BB.Vector(0, 0), new BB.Vector(0, 0), 1);
    var vertex2 = new BB.Vertex(new BB.Vector(235, 380), new BB.Vector(0, 0), new BB.Vector(0, 0), 1);
    var vertex3 = new BB.Vertex(new BB.Vector(350, 400), new BB.Vector(0, 0), new BB.Vector(0, 0), 1);
    var vertex4 = new BB.Vertex(new BB.Vector(330, 700), new BB.Vector(0, 0), new BB.Vector(0, 0), 10);

    var linSpring1_2 = new BB.LinearSpring(vertex1, vertex2, 4.8, 2, 200);
    var linSpring1_3 = new BB.LinearSpring(vertex1, vertex3, 4.8, 2, 300);
    var linSpring2_3 = new BB.LinearSpring(vertex2, vertex3, 4.8, 2, 200);
    ...
    this.bodies.forEach(function (body) {
      body.vertices.forEach(function (vertex) {
        this.boundaries.forEach(function (boundary) {
          ...
          vertex.setAdjacentBoundary(adjacentBoundary);
        });
      }.bind(this));
    }.bind(this));
  }
