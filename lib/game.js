(function () {
  ...
  Game.buildBodies = function () {
    vertex1 = new BB.Vertex(new BB.Vector(255, 200), new BB.Vector(0, 0), new BB.Vector(0, 0), .1)
    vertex2 = new BB.Vertex(new BB.Vector(300, 200), new BB.Vector(0, 0), new BB.Vector(0, 0), .1)
    vertex3 = new BB.Vertex(new BB.Vector(300, 300), new BB.Vector(0, 0), new BB.Vector(0, 0), .1)

    linSpring1_2 = new BB.LinearSpring(vertex1, vertex2, .01, 0.01, 50)
    return [new BB.Body([vertex1, vertex2, vertex3], [linSpring1_2])]
  }
