...
(function () {
  ...
  Game.buildBoundaries = function () {
    ...
    var pos3 = new BB.Vector(0, 0.7 * Game.DIM_Y);
    var pos4 = new BB.Vector(Game.DIM_X, 0.6 * Game.DIM_Y);
    var fixedBoundary2 = new BB.FixedBoundary(pos3, pos4, .005, 0);
  ...
  Game.buildBodies = function (cars) {
    ...
    //
    // var bodies = [new BB.Body([vertex1, vertex2, vertex3], [linSpring1_2, linSpring1_3, linSpring2_3])];

    var bodies = [];

    cars.forEach(function(car) {
      bodies.push(car.body);
    }.bind(this))
